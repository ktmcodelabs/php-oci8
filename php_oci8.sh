...
wget https://github.com/bumpx/oracle-instantclient/blob/master/instantclient-basic-linux-x64-12.1.0.2.0.zip 
wget https://github.com/bumpx/oracle-instantclient/raw/master/instantclient-sdk-linux.x64-x64-12.1.0.2.0.zip
